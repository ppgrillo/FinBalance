              ...
              <div className="flex justify-between items-start">
                  <div>
                      <p className="text-white/80 text-xs font-medium tracking-wider uppercase">
                        {acc.type === 'Credit' ? 'Crédito' : acc.type === 'Investment' ? 'Inversión' : acc.type === 'Cash' ? 'Efectivo' : acc.type === 'Loan' ? 'Préstamo' : 'Débito'}
                      </p>
                      <h3 className="font-bold text-lg tracking-wide mt-1">{acc.name}</h3>
                  </div>
    ...
    <div className="space-y-8 pb-24">
        ...
        <div>
            ...
            {accounts.filter(a => a.type === 'Loan').length > 0 ? (
                ...
                <p className="text-gray-400 text-sm">No tienes préstamos personales registrados. Crea una cuenta tipo "Préstamo" para rastrear deudas a amigos o familiares.</p>
            )}
        </div>
                    ...
                    <div className={`space-y-4 ${isCalibrating ? 'hidden' : 'block'}`}>
                        <div>
                            ...
                            <input 
                                ...
                                placeholder={formAccount.type === 'Loan' ? "Ej. Deuda a Juan" : "Ej. Nómina BBVA"}
                        ...
                        <div className="grid grid-cols-2 gap-4">
                            <div>
                                ...
                                >
                                    ...
                                    <option value="Loan">Préstamo (Persona)</option>
